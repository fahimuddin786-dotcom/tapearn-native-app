...
// ✅ PAGE 3: Mining (Your Existing Mining) - NOW MAIN PAGE
            ...
            <div class="welcome-message">
                <div class="stats-grid-mini">
                    <div class="stat-card-mini">
                        <span class="stat-number-mini" id="totalPoints">${formatNumber(userPoints)}</span>
                        <span class="stat-label-mini">Total Points</span>
                    </div>
                    <div class="stat-card-mini">
                        <span class="stat-number-mini" id="videosWatched">${watchedVideos}</span>
                        <span class="stat-label-mini">Videos</span>
                    </div>
                    <div class="stat-card-mini">
                        <span class="stat-number-mini" id="totalReferrals">${referrals}</span>
    ...
    document.getElementById('currentPage').innerHTML = `
        <div class="earning-success">
            ...
            <div class="success-actions">
                ...
                <button onclick="showPage('mining')" class="action-btn secondary">
                    🏠 Back to Dashboard
                </button>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🎯 Native TapEarn App Initialized - MINING PAGE AS MAIN');
